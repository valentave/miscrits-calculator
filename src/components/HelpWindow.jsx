        ...
        <div className="window-back">
            <div className="help-window">
                ...
                <div className="help-container">
                    <ul>
                        <li>Hi! Here you can simulate or calculate what your miscrit could look like when it reaches level 30.</li>
                        ...
                        <li>In the options menu you can: <br/>
                            <ul>
                                <li>Activate or deactivate both platinum training and bonuses.</li>
                                <li>Rebonus, this randomizes all your bonus or platinum points if they are active.</li>
                                <li>Change all stats nature to white, green or red</li>
                            </ul>
                        </li>
                        <li>In the stats menu you can: <br/>
                            <ul>
                                <li>Hover over the icons or statistics to see the bonuses applied to each one.</li>
                                <li>Click on each icon or statistic to change its nature to white, green or red.</li>
                            </ul>
                        </li>
