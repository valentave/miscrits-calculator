    ...
    return (
        <div className="miscrit-main">
            ...
            <div className="main__image-container">
                <img className={"picture-available-" + (miscrit.available === true ? true : false)} src={miscrit.name.includes("?") ? "./assets/full-pics/missing.webp" : ("./assets/full-pics/" + miscrit.evoName.replaceAll(" ", "_").toLowerCase() + "_back.webp")} alt="" />
            </div>
        </div>
    )
}