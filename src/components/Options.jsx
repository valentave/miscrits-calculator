...
export default function Options({setPlatinum,setBonus, rebonus, changeNature}) {
    ...
    return (
        <div className="options-container">
            <h2>OPTIONS</h2>
            <button onClick={() => setPlatinum()} className="btn-options-1">ADD/REMOVE<br/>PLATINUM</button>
            ...
            <button onClick={() => setBonus()} className="btn-options-4">ADD/REMOVE<br/>BONUS</button>
        </div>
    )
}